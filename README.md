...
A production-quality 18-slide, 16:9 web presentation for Hany Saad's CognitionX Egypt 2026 session, **AI-Native Development: From Writing Code to Owning the Full SDLC**.
...
- `/present/1` through `/present/18` — audience presentation
