...
- One 16:9 slide per page, 16 pages, `13.333in × 7.5in`, zero margins.
...
2. No `IntersectionObserver`, viewport, or scroll-driven reveals — all 16 slides are laid out at once.
...
| Page count ≠ 16 | A slide overflowed `7.5in` or a break rule changed |
